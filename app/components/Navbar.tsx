...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-50 w-auto max-w-[95%]">
      <div className="bg-black/90 backdrop-blur-md border border-white/10 rounded-full px-8 py-3 flex items-center gap-8 shadow-2xl whitespace-nowrap">
        ...
        {/* The "Redacted" History Links */}
        <div className="hidden lg:flex items-center gap-8">
          {displayedTheories.map((theory) => (
            <Link 
              key={theory.id} 
              href={`/theories/${theory.slug}`} // This line uses the 'slug' we added above
